...
Currently, it is possible to compile the example "Hello World" program in "main.otter" and get an executable binary. We have the vertical slice pretty much done and are working on adding more core functionalities.
